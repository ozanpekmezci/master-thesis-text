...
\begin{figure}[htp]
	...
	\end{axis}
	\end{tikzpicture}
	\caption[Unsupervised group recommender accuracy figure]{Effect of diversity constant on unsupervised group recommender to the accuracy}\label{fig:unsupervised-diversity-accuracy}
\end{figure}
...
\begin{figure}[htp]
	...
	\end{axis}
	\end{tikzpicture}
	\caption[Unsupervised group recommender diversity figure]{Effect of diversity constant on unsupervised group recommender to the diversity}\label{fig:unsupervised-diversity-diversity}
\end{figure}
...
\begin{figure}[htp]
	...
	\end{axis}
	\end{tikzpicture}
	\caption[Accuracy in diverse supervised group recommender figure]{Effect of diversity constant on supervised group recommender to the accuracy}\label{fig:supervised-diversity-accuracy}
\end{figure}
...
\begin{figure}[htp]
	...
	\end{axis}
	\end{tikzpicture}
	\caption[Diversity in diverse supervised group recommender figure]{Effect of diversity constant on supervised group recommender to the diversity}\label{fig:supervised-diversity-diversity}
\end{figure}
